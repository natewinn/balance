...
class BankAccountsControllerTest < ActionController::TestCase
  ...
  test "should create bank_account" do
    assert_difference('BankAccount.count') do
      post :create, bank_account: { account_id: @bank_account.account_id, balance: @bank_account.balance, name: @bank_account.name, type: @bank_account.type }
    end
  ...
  test "should update bank_account" do
    patch :update, id: @bank_account, bank_account: { account_id: @bank_account.account_id, balance: @bank_account.balance, name: @bank_account.name, type: @bank_account.type }
    assert_redirected_to bank_account_path(assigns(:bank_account))
  end
